...
pipe = Pipeline(steps=[('pca',pca),('rfclassifier',randomForestClassifier)])
n_components = [30,60,93]
n_estimators = [50,100,1000]

estimator = GridSearchCV(pipe,dict(pca__n_components=n_components,rfclassifier__n_estimators=n_estimators))
estimator.fit(X_train, y_train)

print estimator.scoring
